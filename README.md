...
npx sv@0.13.1 create --template minimal --types ts --add prettier eslint vitest="usages:unit,component" playwright tailwindcss="plugins:typography,forms" devtools-json drizzle="database:postgresql+postgresql:postgres.js+docker:yes" better-auth="demo:password,github" paraglide="languageTags:en, es+demo:yes" storybook mcp="ide:vscode+setup:local" --install npm GuerrillaRS
```
